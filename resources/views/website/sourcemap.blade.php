...
@section('web-content')
    <main class="pt-5">
        ...
        <section class="py-5 mt-5" id="what-we-do" style="background-color: #f1f1f1">
            <div class="container">
                <h2 class="font-weight-light"><img src="{{ asset('img/help.svg') }}" alt="help icon" height="40px"/> Our Services</h2>
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        <div class="shadow-sm mb-5 bg-white p-4">
                            <h4 class="card-title text-uppercase font-weight-normal p-2 text-uppercase">Commodity Supply Services</h4>
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        <div class="shadow-sm mb-5 bg-white p-4">
                            <h4 class="card-title text-uppercase font-weight-normal p-2 text-uppercase">Research Services</h4>
                            <p class="card-text lead">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        <div class="shadow-sm mb-5 bg-white p-4">
                            <h4 class="card-title text-uppercase font-weight-normal p-2 text-uppercase">Management Services</h4>
                            <p class="card-text lead">
